...
- **[scRNA-Flow](https://github.com/xX-its-amit-Xx/scRNA-Flow)** — end-to-end scRNA-seq pipeline (Scanpy/AnnData): filtering, normalization, doublet detection, integration, clustering, marker gene analysis.
- **[ATAC-QC](https://github.com/xX-its-amit-Xx/ATAC-QC)** — chromatin accessibility QC + peak analysis with TSS enrichment, fragment-size distributions, nucleosome banding diagnostics.
- **[OmicsQC](https://github.com/xX-its-amit-Xx/OmicsQC)** — sequencing QC across bulk and single-cell modalities; detects low-quality cells, ambient RNA contamination, batch effects.

### 💊 ML for drug discovery
- **[OpenADMET-PXR](https://github.com/xX-its-amit-Xx/OpenADMET-PXR)** — solo entry in the Hugging Face OpenADMET competition (top 100). 35+ modeling approaches for pEC50 prediction on Pregnane X Receptor, including ChemBERTa fine-tunes, ECFP+LightGBM, and hybrid transformer architectures fusing protein and compound embeddings. Currently exploring **activity-cliff-aware pretraining** to sensitize representations to small structural changes with large activity shifts.
- **[ARES + BayesBio](https://github.com/xX-its-amit-Xx/ARES-BayesBio)** — Bayesian inference + ML pipelines for compound prioritization with calibrated uncertainty.

### 🎮 Outside the lab
- **[OrbitSwap](https://github.com/xX-its-amit-Xx/OrbitSwap)** *(Just Another Studios)* — gravity-puzzle game shipped on Android. Kotlin, original mechanic design.
